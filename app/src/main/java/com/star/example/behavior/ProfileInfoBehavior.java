package com.star.example.behavior;
 ...
 */
public class ProfileInfoBehavior extends ViewOffsetBehavior {
    ...
    public ProfileInfoBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
